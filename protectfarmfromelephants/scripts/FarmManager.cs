...
public partial class FarmManager : Node2D
{
    ...
    private int plantPhase = 1; 
	private RichTextLabel _timer_text;
	private Timer _timer;
	
    private Godot.Collections.Array<Vector2I> plantedTileCoordinates;
	[Export] TileMapLayer _plant_tiles;
	...
	public override void _Ready()
    {
        ...
        StartTimer();
        plantedTileCoordinates = _plant_tiles.GetUsedCellsById(0);
    }
